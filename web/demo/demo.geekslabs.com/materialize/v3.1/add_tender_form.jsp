          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Add_Tender_Form</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Tender_by_publisher</a>
                  </li>
                  <li><a href="#">Tender_table</a>
                  </li>
                  <li class="active">Add_Tender Form</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Add_Tender form</h4>
                    <div class="row">
                      <form class="col s12">
                        <div class="row">
                            ...
                            <label for="first_name">Published Tender</label>
                          ...
                          <a class="btn waves-effect waves-light blue" href="tender_table.jsp">view</a></p>
