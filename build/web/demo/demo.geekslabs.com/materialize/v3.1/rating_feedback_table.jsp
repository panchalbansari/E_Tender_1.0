          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Rating table</h5>
              ...
              <div class="row">
                ...
                <div class="col s12 m8 l9">
                  <table>
                    ...
                    <thead>
                      <tr>
                        <th data-field="id">Ratinf_feedback_id</th>
                         <th data-field="name">Login_id</th>
                         <th data-field="id">Login_id</th>
                         <th data-field="id">Rating_value</th>
                         <th data-field="id">Feedback_description</th>
                        ...
                        <td>2</td>
                        <td>3</td>
                        <td>Work is done with great efficiancy</td>   
