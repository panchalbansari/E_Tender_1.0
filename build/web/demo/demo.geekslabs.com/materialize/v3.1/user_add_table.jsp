          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">User_type table</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Registration</a>
                  </li>
                  <li class=active">User_type
                  </li>
                </ol>
                <div class="divider"></div>
                <p><a class="btn waves-effect waves-light blue" href="add_user_type.jsp">Add User_type form</a></p>
                  ...
                  <table>
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th data-field="name">User_type</th>
