          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Add_Contract_Page_Form</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Contract Page</a>
                  </li>
                  <li><a href="#">Contract_Page_Table</a>
                  </li>
                  <li class="active">Add_Contract_Page Form</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Add_Contract_Page form</h4>
                    <div class="row">
                      <form class="col s12">
                        <div class="row">
                          ...
                          <a class="btn waves-effect waves-light blue" href="contract_page_table.jsp">view</a></p>
