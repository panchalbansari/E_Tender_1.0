          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Reqire_inf_table</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Table</a>
                  </li>
                  <li class=active">Require_info Table
                  </li>
                </ol>
              ...
              <div class="row">
                ...
                <div class="col s12 m8 l9">
                  <table>
                    ...
                    <thead>
                      <tr>
                        <th data-field="id">Require_info_id</th>
                         <th data-field="name">Specialization</th>
                         <th data-field="id">Value_by_tenderer</th>
                         <th data-field="id">Experiance</th>
                         <th data-field="id">No_of_past_projects</th>
                         <th data-field="id">Past_project_value</th>
