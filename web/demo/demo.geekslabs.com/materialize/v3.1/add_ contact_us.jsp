          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Conatct_us Form</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Contact_us</a>
                  </li>
                  <li><a href="#">Contact_us_table</a>
                  </li>
                  <li class="active">Add Contact_us Form</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div id="basic-form" class="section">
              <div class="row">
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Add Contact_us form</h4>
                    <div class="row">
                      <form class="col s12">
                        <div class="row">
              ...
              <!--there is no need of logo of website or compny name -->
                            ...
                            <label for="first_name">Comany Name</label>
                          </div>
                 ...
                 <div class="input-field col s12">
                   ...
                   <div class="input-field col s12">
                     ...
                     <div class="input-field col s12">
                          ...
                          <a class="btn waves-effect waves-light blue" href="contact_us_table.jsp">view</a></p>
