          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Add_System_Contract_Form</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">System Contracts</a>
                  </li>
                  <li><a href="#">System_Contract_Table</a>
                  </li>
                  <li class="active">Add_System_Contract Form</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Add_System_Contract form</h4>
                    <div class="row">
                      <form class="col s12">
                        <div class="row">
                            ...
                            <div class="col s12 m8 l9">
                             <input type="date" class="datepicker">Date
                               </div>
                            
                            <div class="input-field col s12">
                            <input id="name" type="text">
                            <label for="first_name">Time Duration</label>                            
                          </div>
                          ...
                          <a class="btn waves-effect waves-light blue" href="system_contract_table.jsp">view</a></p>
