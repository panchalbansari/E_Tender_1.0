          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Add_Login Form</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Login</a>
                  </li>
                  <li><a href="#">Login_table</a>
                  </li>
                  <li class="active">Add_Login_Form</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div id="basic-form" class="section">
              <div class="row">
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Login form</h4>
                    <div class="row">
                      <form class="col s12">
                        <div class="row">
              ...
              <!--there is no need of logo of website or compny name -->
                          ...
                          <p><a class="btn waves-effect waves-light blue">Login</a></p>
                          <p>Forgot your login details?</p>
                          <p><a href="forgot_password.jsp">get help</a></p>
