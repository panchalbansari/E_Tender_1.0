          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Download_tender_Table</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Download tenders</a>
                  </li>
                  <li class=active">Download_tender Table
                  </li>
                </ol>
                <div class="divider"></div>
                <p><a class="btn waves-effect waves-light blue" href="download_tenders_form.jsp">Add_Download_Tenders form</a></p>
              ...
              <div class="row">
                ...
                <div class="col s12 m8 l9">
                  <table>
                    ...
                    <thead>
                      <tr>
                        <th data-field="id">Download_tenders_id</th>
                         <th data-field="name">Download_tenders_path</th>
