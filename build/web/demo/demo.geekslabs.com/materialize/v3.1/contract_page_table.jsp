          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Contract_page_Table</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Contract Page</a>
                  </li>
                  <li class=active">Contract_Page_table
                  </li>
                </ol>
                <div class="divider"></div>
                <p><a class="btn waves-effect waves-light blue" href="add_contract_page_form.jsp">Add_Contract_Page form</a></p>
              ...
              <div class="row">
                ...
                <div class="col s12 m8 l9">
                  <table>
                    ...
                    <thead>
                      <tr>
                        <th data-field="id">Contract_id</th>
