          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Publisher_history_Table</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Publisher_history</a>
                  </li>
                  <li class=active">Publisher_history_Table
                  </li>
                </ol>
                <div class="divider"></div>
                <p><a class="btn waves-effect waves-light blue" href="add_publisher_history_form.jsp">Add_Publisher_history form</a></p>
              ...
              <div class="row">
                ...
                <div class="col s12 m8 l9">
                  <table>
                    ...
                    <thead>
                      <tr>
                        <th data-field="id">Published_history_id</th>
                         <th data-field="name">Project_duration</th>
                          <th data-field="name">Publisher_name</th>
                         <th data-field="name">Tendere_name</th>
                         <th data-field="name">Project_subject</th>
