          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Add_Tender table</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Table</a>
                  </li>
                  <li class=active">Add_Tender
                  </li>
                </ol>
              ...
              <div class="row">
                ...
                <div class="col s12 m8 l9">
                  <table>
                    ...
                    <thead>
                      <tr>
                        <th data-field="id">Add_tender_id</th>
                         <th data-field="name">Tender_Subject</th>
                         <th data-field="id">Value</th>
                         <th data-field="id">Closing_date</th>
                         <th data-field="id">Location</th>
                         <th data-field="id">Referance_no</th>
                         <th data-field="id">Category</th>
                         <th data-field="name">Detail_PDF</th>
                         <th data-field="name">Term_condition_PDF</th>
                         <th data-field="name">Other_PDF</th>
