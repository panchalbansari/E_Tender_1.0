          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Tender_Table</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Tender_by_publisher</a>
                  </li>
                  <li class=active">Tender_Table
                  </li>
                </ol>
                <div class="divider"></div>
                <p><a class="btn waves-effect waves-light blue" href="add_tender_form.jsp">Add_Tender form</a></p>
              ...
              <div class="row">
                ...
                <div class="col s12 m8 l9">
                  <table>
                    ...
                    <thead>
                      <tr>
                        <th data-field="id">Published_tender_id</th>
                         <th data-field="name">Published_tender_path</th>
