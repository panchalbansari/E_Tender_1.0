          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Forgot Password Form</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html"></a>
                  </li>
                  
                  <li class="active">Forgot_Password_Form</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div id="basic-form" class="section">
              <div class="row">
                <div class="col s12 m12 l6">
                  <div class="card-panel">
                    <h4 class="header2">Forgot password form</h4>
                    <div class="row">
                      <form class="col s12">
                        <div class="row">
              ...
              <!--there is no need of logo of website or compny name -->
                            ...
                            <label for="first_name">Registerd Email</label>
                           
                          </div>
                        
                           <p><a class="btn waves-effect waves-light blue">Send</a></p>
