          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Comman_Registration table</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Table</a>
                  </li>
                  <li class=active">Comman_Registration_table
                  </li>
                </ol>
              ...
              <div class="row">
                ...
                <div class="col s12 m8 l9">
                  <table>
                    ...
                    <thead>
                      <tr>
                        <th data-field="id">Registraion_id</th>
                         <th data-field="name">User_type_name</th>
                         <th data-field="id">Area_name</th>
                         <th data-field="id">Fname</th>
                         <th data-field="id">Lname</th>
                         <th data-field="id">DOB</th>
                         <th data-field="name">Address</th>
                         <th data-field="id">Gender</th>
                         <th data-field="price">Pincode</th>
                         <th data-field="id">Phone_no</th>
