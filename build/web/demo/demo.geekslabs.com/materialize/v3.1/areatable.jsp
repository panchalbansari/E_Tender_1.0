          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Area table</h5>
                ...
                <p><a class="btn waves-effect waves-light blue" href="addarea.jsp">Add area form</a></p>
                  ...
                  <table>
                    ...
                    <thead>
                      <tr>
                        ...
                        <td>Ahmedabad</td>
                        <td>Bopal</td>
                        <td><a href="edit_area">Edit</td>
                        <td><a href="edit_area">Delete</td>
                       </tr>
