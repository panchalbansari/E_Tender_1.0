          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Logo table</h5>
                <ol class="breadcrumbs">
                  <li><a href="index.html">Logo</a>
                  </li>
                  <li class=active">Logo table
                  </li>
                </ol>
                <div class="divider"></div>
                <p><a class="btn waves-effect waves-light blue" href="logo_form.jsp">Add logo form</a></p>
