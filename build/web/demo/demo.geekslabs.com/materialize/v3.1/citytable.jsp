          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">City table</h5>
                ...
                <p><a class="btn waves-effect waves-light blue" href="addcity.jsp">Add city form</a></p>
                  ...
                  <table>
                    ...
                    <thead>
                      <tr>
                        ...
                        <td>Gujarat</td>
                        <td>Ahmedabad</td>
                        <td><a href="edit_city">Edit</td>
                        <td><a href="edit_city">Delete</td>
                       </tr>
